...
<jsp:include page="../header.jsp"></jsp:include>
  <main style="margin-top: 100px;">
    <div class="content" style="position: relative;">
      ...
      <div class="product">
        <c:forEach items="${orderOkList}" var="order">
          <p class="productTitle">상품명: ${order.book_title}</p>
          <p class="productDescription">주문수량:${order.book_count}개</p>
          <p class="productPrice">가격: ${order.book_price*order.book_count}원</p>
        </c:forEach>
      </div>
      <div class="address">
