...
<div class="boxes" style="width: 95%;">
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td class="table-light"><span>{}</span> 건</td>
            <td class="table-light" rowspan="3" style="text-align: center;">
                <div style="display: flex; flex-direction: column; justify-content: space-around; flex-wrap: nowrap; height: 100%">
                    ...
                    <input class="btn btn-warning" type="button" value="상품 입고 >">
                    <input class="btn btn-warning" type="button" value="상품 관리 >">
                    <input class="btn btn-warning" type="button" value="재고 관리 >" onclick="location.href='product?page=product_stock_manager'">
                </div>
            </td>
        </tr>
        <tr>
...
<%--        <tr>--%>
<%--            <td class="table-warning">종료 10일전 상품</td>--%>
<%--            <td class="table-light"><span>{}</span> 건</td>--%>
<%--        </tr>--%>
    </table>
</div>
