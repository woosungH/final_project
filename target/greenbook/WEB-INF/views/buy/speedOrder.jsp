  ...
  <div class="content">
    <table class="content_tb" >
      <tr class="content_tb_top">
        ...
        <input type="hidden" class="book_id_input" name="book_id" value="${book_id}">
        <input type="hidden" class="book_price_input" name="book_price" value="${book_price}">
        <tr style="margin-bottom:15px;">
          <td><img src="upload/${cartImg}" alt="" width="150" height="180"></td>
          <td>${book_title}<br>
              ${book_author} 저 | ${book_publisher} <br> ${book_description}
          </td>
          <td><input type="number" id="oqty" name="price" value="${book_price}" readonly style="width: 100px; "></td>
          <td>주문일로부터 최소 2일</td>
        </tr>
    </table>
  </div>
    ...
    <div class="col-md-4 order-md-2 mb-4">
      ...
      <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-condensed">
            ...
            <span class="text-muted">${book_price}원</span>
          </li>
        <li class="list-group-item" style="text-align:center;">
          <span>합계</span>
          <strong>${book_price}원</strong>
        </li>
      </ul>
    </div>
    <div class="col-md-8">
...
<script>
  $("#kakao").click(function (){
    location.href = 'speedOrderKakaoPay?totalMoney=${book_price}&book_id=${book_id}';
  })
</script>
